...
if_stmt: IF LP or_expr RP LEFT_BRACES statements RIGHT_BRACES IF_END | IF LP or_expr RP LEFT_BRACES statements RIGHT_BRACES ELSE LEFT_BRACES statements RIGHT_BRACES
...
term: factor | term MULT_OP factor | term DIV_OP factor | term MOD_OP factor
factor: power | power EXP_OP factor
power: LP expr RP | IDENT | INT | return_func_call | timer | receive_value | get_sensor | FLOAT
